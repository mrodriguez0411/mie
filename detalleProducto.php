     ...
     <div class="card-body">
         <div class="row">
             ...
             <div class="col-12 col-sm-6">
                 ...
                 <h4 class="mt-3">Stock: <?php echo $rowProducto['stock']; ?></h4>


                 <div class="bg-gray py-2 px-3 mt-4">
                     <h2 class="mb-0">
                         Precio: $<?php echo number_format($rowProducto['precio'], 2, ',', '.') ?>
                     </h2>

                 </div>

                 <div class="mt-4">
                     <button class="btn btn-primary btn-lg " id="agregarCarrito"
                ...
                <div class="mt-4">
                    <a href="index.php"> 
                    <button class="btn btn-dark btn-sm " id="agregarCarrito">
